...
const index = () => {
  ...
  const updateUserDescription = async () => {
    try {
      const response = await axios.put(
        `${EXPO_PUBLIC_API_URL}/users/${userId}/description`,
        {
  ...
  const addLookingFor = async (lookingFor) => {
    try {
      const response = await axios.put(
        `${EXPO_PUBLIC_API_URL}/users/${userId}/looking-for`,
        {
  ...
  const removeLookingFor = async (lookingFor) => {
    try {
      const response = await axios.put(
        `${EXPO_PUBLIC_API_URL}/users/${userId}/looking-for/remove`,
        {
          lookingFor: lookingFor,
        }
      );
  ...
  const addTurnOn = async (turnOn) => {
    try {
      const response = await axios.put(
        `${EXPO_PUBLIC_API_URL}/users/${userId}/turn-ons/add`,
        {
          turnOn: turnOn,
        }
      );
  ...
  const removeTurnOn = async (turnOn) => {
    try {
      const response = await axios.put(
        `${EXPO_PUBLIC_API_URL}/users/${userId}/turn-ons/remove`,
        {
          turnOn: turnOn,
        }
      );
  ...
  const handleAddImage = async () => {
    try {
      const response = await axios.post(
        `${EXPO_PUBLIC_API_URL}/users/${userId}/profile-images`,
        {
          imageUrl: imageUrl,
        }
      );
